  ...
  return (
    ...
    <Card title={<Title level={5}>Sent Statistics</Title>} className="shadow rounded-lg mt-7 p-4">
      ...
      <Radio.Group className="mt-5" onChange={onFilterChange} value={filterType}>
        <Radio value="Date Wise" style={{ color: filterType === "Date Wise" ? "green" : "inherit" }}>
          Date Wise
        </Radio>
        <Radio value="Instance Wise" style={{ color: filterType === "Instance Wise" ? "green" : "inherit" }}>
          Instance Wise
        </Radio>
        <Radio value="Number Wise" style={{ color: filterType === "Number Wise" ? "green" : "inherit" }}>
          Number Wise
        </Radio>
        <Radio value="Delivery Wise" style={{ color: filterType === "Delivery Wise" ? "green" : "inherit" }}>
          Delivery Wise
        </Radio>
      </Radio.Group>
    </Card>
